...
const allUpperCase = (arr) => {
  let mainArray = [];
  arr.forEach(string => {
    mainArray.push(string.toUpperCase());
  });
  return mainArray;
};
...
const speaker = (words, callback) => {
  ...
  words.forEach(string => {
    mainArray.push(callback(string));
  });
  return mainArray;
};
...
const addNumbers = (num, arr, numberOfTimes, callback) => {
